...
window.useCandidateProfile = useCandidateProfile;
window.AppSwitcherRow = AppSwitcherRow;
window.CandidateIdentityRow = CandidateIdentityRow;
window.MiniPipeline = MiniPipeline;
