...
window.ET_CATS = ET_CATS;
window.ET_TEMPLATES = ET_TEMPLATES;
window.ET_PREVIEW_CANDS = ET_PREVIEW_CANDS;
window.ET_SYS_VARS = ET_SYS_VARS;
window.ET_CUSTOM_VARS = ET_CUSTOM_VARS;
