...
export const CT_COLOR = { applied: "neutral", screening: "info", interview: "accent", assessment: "purple", offer: "warning", hired: "success", rejected: "neutral", other: "neutral" };
...
export function mkStage(en, ar, type, count, email, opts) {
  return S(en, ar, type, count, email, opts);
}

window.CT_COLOR = CT_COLOR;
window.WORKFLOWS = WORKFLOWS;
window.mkStage = mkStage;
